...
public class Voyageur  implements java.io.Serializable {
    ...
    private fr.gtm.bovoyages.services.soap.LocalDate dateNaissance;
    ...
    public Voyageur(
           ...
           fr.gtm.bovoyages.services.soap.LocalDate dateNaissance,
           long id,
     ...
     */
    public fr.gtm.bovoyages.services.soap.LocalDate getDateNaissance() {
        return dateNaissance;
    }
     ...
     * @param dateNaissance
     */
    public void setDateNaissance(fr.gtm.bovoyages.services.soap.LocalDate dateNaissance) {
        this.dateNaissance = dateNaissance;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.services.bovoyages.gtm.fr/", "voyageur"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://soap.services.bovoyages.gtm.fr/", "localDate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
